...
function onYouTubePlayerReady(event) {
  ...
  var videoDomElem = document.getElementById(event.target.getIframe().getAttribute("id"));
...
var storage = localStorage.getItem('modal__input--login'); // Открытие окна и тени
...
form.addEventListener('submit', function (event) {
  if (!login.value || !password.value) {
    popup.classList.remove('modal__error'); //popup.offsetWidth = popup.offsetWidth;
